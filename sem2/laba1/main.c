// Имеются сведения о кубиках: размер каждого кубика (длина ребра в сантиметрах), его цвет (красный, жёлтый, зелёный и синий) и материал (дерево, металл, картон). Найти:
// а) количество кубиков каждого из перечисленных цветов и их суммарный объём;
